...
export default function Testimonios() {
  ...
  const testimonies = [
    ...
    },
    {
      name: "Valeria Rivera",
      year: "XII",
      quote: "Estar en Célula ha sido mi mejor experiencia en la vida académica, no solo me enamoré de la tecnología, programación y redes, sino que también hice las mejores amistades y experiencias. Mejoré como estudiante y como persona.",
    },
    {
    ...
    },
    {
      name: "Arturo Macias",
      year: "X",
      quote: "Un programa que fomenta la verdadera educación, desde la vocación y el compromiso, una gran plataforma de conocimiento.",
    },
    {
      name: "Carlos Eduardo",
      year: "XVII",
    ...
    {
      name: "Grecia Sanjuanico",
      year: "XVII",
      quote: "Célula para mi fue y sigue siendo una familia en la que aprendí muchísimo y me hizo amar lo que hacía, así como la pasión por las cosas que nos gustan.",
    },
